#ifndef ADAPTIVE_THREAD_POOL_B_HPP
#define ADAPTIVE_THREAD_POOL_B_HPP
...
public:
    ...
    // 생성자 
    AdaptiveThreadPoolB(size_t min_thread_size, size_t max_thread_size);
